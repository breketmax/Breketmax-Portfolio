      ...
      <div className={styles.history_block_content}>
        ...
        <div className={styles.history}>
          ...
          <Typography tag="p" size="m">Все началось в 2012 году с flash игр в браузере, уже тогда маленький я заинтересовался принципами работы веб-страниц и спустя пару лет решился все таки попробовать программирование, а начал с самого легкого, по статистике, языка C++.
              ...
              {<br/>}
              {<br/>}
              Далее по накатанной, выбор фреймворка, прохождение курсов, наполнение портфолио, освоение новых технологий, прохождение собеседований, первая галера, первая стажировка и постоянное место работы. Пройдено не мало, но впереди еще больше, и как говорил один китайский мудрец:
          </Typography>
        ...
        <div className={styles.quote}>
          ...
          <Typography tag="p">安德烈·科索拉波夫</Typography>
        </div>
